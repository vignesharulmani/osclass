...
<div class="mb-body">
  <div class="mb-info-box" style="margin:5px 0 30px 0;">
    ...
    <div class="mb-line" style="margin:10px 0;"><a href="https://mb-themes.com/theme-plugins/veronika_plugins_20180307_Gkd2k1.zip" target="_blank" class="mb-button-white"><i class="fa fa-download"></i> <?php _e('Download plugins', 'veronika'); ?></a></div>
